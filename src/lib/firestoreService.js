 ...
 */
export const saveQuizResult = async (userId, chapterId, quizData) => {
    try {
 ...
 */
export const getChapterProgress = async (userId, chapterId) => {
    try {
        const progressDoc = await getDoc(doc(db, 'userProgress', `${userId}_${chapterId}`));
