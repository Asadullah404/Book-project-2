...
import { Search, Moon, Sun, LogOut, PlusCircle, BookOpen, BarChart3 } from 'lucide-react';
...
export default function Navbar() {
    const { theme, toggleTheme, toggleAddContentModal, setSearchModalOpen } = useStore();
