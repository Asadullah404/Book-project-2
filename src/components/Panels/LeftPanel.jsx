    ...
    useEffect(() => {
        const fetchLibrary = async () => {
            ...
            try {
                ...
                // Merge or append. 
                // We'll treat the local chapters as a separate "book" or category for clarity, 
                // or just append them if they are top-level items.
                // The generated library.json is a list of chapters. 
                // Let's wrap them in a "Local Book" category if needed, or just add them.

                // If the local items are chapters, we might want to group them.
                const localBook = {
                    id: 'local-book-1',
                    title: 'Auralization (Extracted Chapters)',
                    type: 'category', // or 'book' if your system supports it
                    children: localBooks
                };

                setLibrary([...firestoreBooks, localBook]);
            } catch (error) {
